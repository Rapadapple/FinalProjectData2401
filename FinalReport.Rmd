...
- This data set was ultimately found by Kevin Sheard in agreement with John Beall and Andrew Vo. We thought the data set was large, thorough, and well produced. There were changes we created in the column titles for ease of use. As far as extraordinary peculiarities with the data set, we have no comment. Our data source is very solid. 
