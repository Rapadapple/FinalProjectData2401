...
energy %>% 
  ...
  labs(title = "US average power generation per year", y = "Generation(TWH)", x = "Year") 
...
energy %>% 
  ...
  ggplot() +
  geom_col(aes(x = state, y = generation/1000000, fill = source)) +
  labs(title = "States with negative power generation (<-5000)", x ="State", y="Power Generation(TWH)")
```
