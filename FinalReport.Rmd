...
To better understand where the distribution of power is coming from for the US in general.
...
To better understand where the distribution of power is coming from for TX specifically, we can notice that TX more heavily relies on Independent Power Producers. Probably due to our independent energy grid. 
